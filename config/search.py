...
search_terms = ["AI Engineer", "Cloud Architect", "DevOps Engineer", "Cloud Engineer", "AI Architect", "Cloud & AI Lead", "DevSecOps Engineer", "Site Reliability Engineer", "Platform Engineer", "Infrastructure Architect", "AIOps Engineer"]
...
bad_words = ["US Citizen", "USA Citizen", "No C2C", "No Corp2Corp",  "Security Clearance", "US Citizens Only", "Green Card"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
...
current_experience = 15            # Integers > -2 (Ex: -1, 0, 1, 2, 3, 4...)
##
